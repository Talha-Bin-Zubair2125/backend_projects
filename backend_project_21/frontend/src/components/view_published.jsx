...
import "../style/View_published.css";
  ...
  useEffect(() => {
    const fetchPublishedPosts = async () => {
      try {
        ...
        const filtered_data = data_received.filter((p) => p.status === "Published");
            ...
            {publishedPosts.map((post) => (
              <div key={post._id} className="post-card">
                <div className="post-card-header">
                  <h3 className="post-card-title">{post.post_topic || "Untitled Post"}</h3>
                ...
                <div className="post-card-content">
                  <p className="post-card-excerpt">
                    {post.post_content 
                      ? post.post_content.substring(0, 150) + (post.post_content.length > 150 ? "..." : "")
